# SNAILS v2.0
Since purblishing, we have created a new version that is more mobile, efficient, and adaptable. This design also works with the more-common, upright Eppendorf pipette rather than the self-standing Ovation pipette. Please navigate to the SNAILS_v2 folder for the design.
